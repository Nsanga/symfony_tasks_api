 ...
 */
final class Version20240616104045 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task CHANGE owner_id owner_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task CHANGE owner_id owner_id INT DEFAULT NULL');
